...
declare class ItemContainer {
	...
	/**
		 ...
		 */
	setBinding(elementName: UI.ElementName, bindingName: string, value: any): void
	/**
	 ...
	 * doesn't exist
	 */
	getBinding(elementName: UI.ElementName, bindingName: string): any
	/**
	...
	*/
	...
	static registerScreenFactory(name: string, screenFactory: (container: ItemContainer, name: string) => UI.Window | UI.WindowGroup): void
}
...
declare namespace UI {
	...
	interface UISlotElement extends UIElement {
		...
		onItemChanged?: (container: Container | ItemContainer, oldId: number, oldData: number, oldCount: number) => void
		isValid?: (id: number, count: number, data: number, container: Container | ItemContainer, item: ItemInstance) => boolean
	}
	...
	interface UIClickEvent {
		onClick?(uiHandler: any, container: ItemContainer, uiElement: UI.Elements, position: Vector): void
